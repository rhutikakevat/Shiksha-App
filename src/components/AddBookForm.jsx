...
const AddBookForm = () => {
    ...
    return(
        ...
        <form onSubmit={formHandler} className="py-2">
            ...
            <input type="text" className="form-control" placeholder="Fiction, Self-help, Business, Autobiography etc..." name="genre" value={formData.genre} onChange={handlerOfChange}/>
            <br />
